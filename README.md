...
- **ML 엔지니어** 매일 쓰는 프레임워크 내부를 알고 싶은 사람.
...
프로그래밍 초보를 위한 소개는 아님. 최소한 파이썬 코드는 편안하게 읽고 ML 개념을 겉핥기는 해 뒀어야 함. 더 깊은 곳을 보여줄 거임.
...
처음 README.md를 번역 후  Claude (Anthropic)에게 맡김. 처음 번역 품질이 마음에 들지 않았기 때문에 처음 원문에서 받은 인상을 적용해서 직접 번역 후 말투와 단어를 유지하게 함.
